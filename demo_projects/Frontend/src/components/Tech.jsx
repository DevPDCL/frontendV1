...
const Tech = () => {
  return (
    ...
    <h3 className='text-[#00a884]  text-center text-[40px] font-bold'>Corporate Partners</h3>
    ...
    <div className="bg-[#00a884] opacity-90 mx-auto w-full ">
    ...
    <div className="bg-[#00a884] px-4 py-6 mt-5 md:flex md:items-center md:justify-between ">
        
        <div className="flex mt-4 sm:justify-center  md:mt-0 space-x-5 rtl:space-x-reverse max-w-7xl mx-auto">
        <span className="text-sm text-black dark:text-black sm:text-center me-auto">© 2023 <a href="https://flowbite.com/">Popular Diagnostic Centre Ltd.</a>
        </span>
